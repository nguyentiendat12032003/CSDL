...
{  
    public partial class Form1 : Form
    {
        ...
        bool isthem;
        private void btn_them_product_Click(object sender, EventArgs e)
        {
            isthem = true;
        ...
        {
            if(MessageBox.Show("Có muốn xóa?","Thông báo", MessageBoxButtons.YesNo,MessageBoxIcon.Question)== DialogResult.Yes)
            {
